...
namespace Office_Manager
{
    public partial class UnitList : Form
    {
        ...
        public UnitList(string firm, byte[] logo)
        {
            InitializeComponent();
            this.firm = firm;
            this.logo = logo;
        ...
        private void UnitList_Load(object sender, EventArgs e)
        {
            ...
            string sql = "select Unit_name Unit from Unit where firm = '" + firm + "' order by Unit_name";
        ...
        private void cellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridView1.CurrentCell.ColumnIndex.Equals(0) && e.RowIndex != -1)
            {
                ...
                {
                    var targetForm = new NewUnit(firm, logo, dataGridView1.CurrentCell.Value.ToString());
