...
{
    public partial class GodownStockFilter : Form
    {
        string firm;
        GodownStockReport gsr;

        Dictionary<string, bool> waterMarkActive = new Dictionary<string, bool>();
        string filterCondition;
        string[] months = { "JAN", "FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG", "SEP", "OCT", "NOV", "DEC" };

        public GodownStockFilter(string firm, GodownStockReport gsr)
        {
            InitializeComponent();
            this.firm = firm;
            this.gsr = gsr;
        ...
        private void GodownStockFilter_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            gsr.clearAndPopulate(firmFilter, filterCondition);
            Close();
        }
    }
}
